      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            We're a passionate team dedicated to helping businesses grow by
        ...
        >
          <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Since our founding, we've helped startups and enterprises alike
            unlock their potential online through custom websites, digital
            strategy, and visual storytelling. Our mission is to create
            experiences that inspire action and drive results.
          </p>
        </motion.div>
        ...
        <motion.div
          className=" text-white p-10 rounded-2xl text-center shadow-lg"
        ...
        >
          ...
          <p className="mb-6">
            Whether you're launching a startup or scaling your business — we're

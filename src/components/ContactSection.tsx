          ...
          >
            ...
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full cursor-pointer py-4 bg-gradient-to-r from-[#FB2056] to-[#FB2056] text-white font-bold rounded-xl shadow hover:shadow-lg transition-all flex items-center justify-center gap-3"
              >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  ...
                  <motion.a
                    ...
                    whileHover={{ y: -3 }}
                    href="#"
                    className={`border p-4 rounded-xl transition-all flex max-[470px]:flex-col items-start gap-3 ${social.color}`}
                  >
